...
Watcher.prototype._handleByClient = function(client, filePath) {
    ...
    //检查当前 client 的 pageInfo 中是否包启变动的文件
    if (filePath != client.pageInfo.url &&
        !client.pageInfo.files.some(function(file) {
